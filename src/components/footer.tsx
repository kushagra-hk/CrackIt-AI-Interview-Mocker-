        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <SocialLink
                href="https://www.facebook.com/share/1GJ5civaRH/"
                icon={<Facebook size={24} />}
                hoverColor="text-blue-500"
              />
              <SocialLink
                href="https://x.com/Kushagra_hk?t=wFfWmdcmUwtAfBYxXZOxlw&s=08"
                icon={<Twitter size={24} />}
                hoverColor="text-blue-400"
              />
              <SocialLink
                href="https://www.instagram.com/kushagra_hk?igsh=bWY4eWhncTExaG8z"
                icon={<Instagram size={24} />}
                hoverColor="text-pink-500"
              />
              <SocialLink
                href="https://www.linkedin.com/in/kushagra-gupta-14101a316/"
